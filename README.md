...
This directory contains comprehensive technical documentation extracted from the official Croatian Government technical specification (Fiskalizacija - Tehnička specifikacija za korisnike v2.6).
...
│   ├── 00-document-overview.md            # Document statistics and structure
│   ├── 01-02-introduction-and-solution.md # System overview and architecture
│   ├── 03-registration-authentication.md  # FINA system and certificates
│   ├── 04-electronic-signature.md         # XML signature implementation
│   ├── 05-services-overview.md            # All CIS services overview
│   ├── 06-11-services-detailed.md         # Detailed service documentation
│   ├── 12-message-examples.md             # Complete XML message examples
...
2. **Fiskalizacija računa** (Invoice Fiscalization) - Submit invoices, get JIR
3. **Promjena načina plaćanja** (Payment Change) - Update payment methods
4. **Fiskalizacija ISSN** (ISSN) - ISSN-specific fiscalization
5. **Izvješće o izdanom računu** (Invoice Report) - Generate PD/PO reports
...
| Field | Value |
|-------|-------|
| **Source** | Fiskalizacija - Tehnička specifikacija za korisnike |
| **Version** | 2.6 |
